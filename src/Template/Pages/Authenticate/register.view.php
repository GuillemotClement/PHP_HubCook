<form action="" class="w-96" method="post">
  ...
  <div class="form-control">
    ...
    <input type="password" id="confirm-password" name="confirm-password" class="input input-bordered" required>
  </div>
  <div class="">
  ...
  <div class="flex justify-center my-4 gap-x-5">
    ...
    <button type="submit" class="btn btn-neutral">Inscription</button>
  </div>
</form>
